...
public class TitlePanel extends JPanel{
	...
	private void init() {
        ...
        minimizeButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(TitlePanel.class.getResource("icon/minimizeIcon.png"))));
        ...
        closeButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(TitlePanel.class.getResource("icon/closeIcon.png"))));
        ...
        title.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(TitlePanel.class.getResource("icon/Logo.png"))));
        this.add(title);
        //---------------------------------------------------------------------------
